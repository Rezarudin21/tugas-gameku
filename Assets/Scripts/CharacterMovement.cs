...
public class CharacterMovement : MonoBehaviour
{
    ...
    private PlayerFallDeath fallDeath; // optional, jika ingin gunakan script khusus
    ...
    void Start()
    {
        ...
        // Coba cari komponen PlayerFallDeath jika ada
        fallDeath = GetComponent<PlayerFallDeath>();
    }
    ...
    void CheckFallDeath()
    {
        if (transform.position.y < deathHeight)
        {
            if (fallDeath != null)
            {
                fallDeath.ForceDeath();
            }
            else
            {
                Debug.Log("Player jatuh dan mati (tanpa UI)"); // fallback
